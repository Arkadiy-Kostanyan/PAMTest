...
using WebLottery.Core.ProjectAggregate;
using WebLottery.Core.Services;
using WebLottery.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace WebLottery.UnitTests.Core.Services
{
